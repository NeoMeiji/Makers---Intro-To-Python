...
# This kind of 'decimal point' number, 0.6666666666666666 is called a float, by the way, meaning 'floating point'.
...
# There are many more operators in Python that you can research. 
# You're very welcome to try out a few below:

# OPERATOR PLAYGROUND STARTS

# == Greater Than ==
greater_than = 77 > 7
print(f"77 > 7 = {greater_than}")
